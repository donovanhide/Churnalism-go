...
(function($) {
  ...
  $.fn.truncate = function(options) {
    ...
    $(this).each(function() {
      ...
      findNodeForMore(truncated_node).append('…&nbsp;<a class="showToggle" >'+opts.more+'</a>');
      findNodeForLess(full_node).append('&nbsp;<a class="showToggle">'+opts.less+'</a>');
      ...
      // truncated_node.find('a:last').addClass('showmore');
      // $('.showmore').live('click',function() {
      //   truncated_node.hide(); full_node.show(); return false;
      // });
      // full_node.find('a:last').addClass('showless');
